...
public class SQLRequestTOConnectionManager extends Attachement{

	protected SQLRequestTOConnectionManager( PortFourni pF,
			PortRequis pR, RoleFrom rF, RoleTo rT) {
		super("SQLRequestTOConnectionManager", pF, pR, rF, rT);
